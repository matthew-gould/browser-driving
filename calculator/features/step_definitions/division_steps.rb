When /^I am dividing (\d+) by a certain (\d+)$/ do |num1, num2|
  ...
  @res2 = Calculator.divide(num2.to_i, num1.to_i)
end
...
When /^I am dividing (\d+) by (\d+) by (\d+)$/ do |num1, num2, num3|
  @res = Calculator.divide(num1.to_i, num2.to_i, num3.to_i)
  @res2 = Calculator.divide(num2.to_i, num3.to_i, num1.to_i)
  @res3 = Calculator.divide(num3.to_i, num1.to_i, num2.to_i)
end
